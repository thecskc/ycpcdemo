                    ...
                    <div>
                        ...
                        >
                            ...
                            <div className="app-inner-layout__wrapper">
                                    ...
                                    <div className="bg-white">
                                        <Table responsive className="text-nowrap table-lg mb-0" hover>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 6.5/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                                <Button color="primary" className="btn-wide" outline>Full
                                                    Report</Button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 6.2/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 6.0/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 5.8/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 5.5/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 5.3/6</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 5.0/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 4.8/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td className="text-left">Overall Score - 4.4/7</td>
                                                <td>
                                                    <FontAwesomeIcon className="opacity-4" icon={faTags}/>
                                                </td>
                                                <td>
                                ...
                                <Card className="app-inner-layout__sidebar" style={{"display":"none"}}>
                                    <Nav vertical>
